    ...
    def check_report(self):
       if self.type == 'purchase':
            ...
            #        datas = self.read(self.id)[0]
                    ...
                    return self.env.ref('fiscal_book.report_purchase_book').report_action(self, data=data) #, config=False
                else:
            ...
            if self.date_start and self.date_end:
               ...
               #     datas = self.read(self.ids)[0]
                  ...
                  #      'context': self._context
                    ...
                    return self.env.ref('fiscal_book.report_sale_book').report_action(self, data=data, config=False)
                else:
                    raise ValidationError('Advertencia! No existen facturas entre las fechas seleccionadas')
...
class PurchaseBook(models.AbstractModel):
    ...
    _name = 'report.fiscal_book.report_fiscal_purchase_book'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for h in purchasebook_ids:
            ...
            if (partner_1.company_type == 'company' or  partner_1.company_type == 'person') and (partner_1.people_type_company or partner_1.people_type_individual) and  (partner_1.people_type_company == 'pjdo' or partner_1.people_type_individual == 'pnre' or  partner_1.people_type_individual == 'pnnr'):
            ...
            if (partner_1.company_type == 'company' or  partner_1.company_type == 'person') and (partner_1.people_type_company or partner_1.people_type_individual) and  partner_1.people_type_company == 'pjnd':
...
class FiscalBookSaleReport(models.AbstractModel):
    _name = 'report.fiscal_book.report_fiscal_sale_book'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for line in fbl_obj:
            if line.vat_general_base != 0 or line.vat_reduced_base != 0 or line.vat_additional_base != 0 or line.vat_exempt != 0 or (line.void_form == '03-ANU' and line.invoice_number):
                vat_general_base = 0
                vat_general_rate =  0
                vat_general_tax =  0
                vat_reduced_base = 0
                ...
                if line.vat_additional_base and line.vat_additional_base != 0:
                    ...
                    vat_additional_rate = (line.vat_additional_base and line.vat_additional_tax * 100 / line.vat_additional_base)
