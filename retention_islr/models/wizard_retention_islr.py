...
class RetentionISLR(models.Model):
    ...
    def generate_retention_islr_xls(self):
        ...
        writer.write_merge(row, row, 1, 6, "*RELACIÓN DETALLADA DE I.S.L.R. RETENIDO - NUEVO FORMATO*",
    ...
    def generate_retention_islr_pdf(self):
        ...
        data = {
            'ids': self.ids,
            'model': 'report.retention_islr.report_retention_islr1',
            'form': {
        ...
        return self.env.ref('retention_islr.action_report_retention_islr').report_action(self, data=data)
...
class ReportRetentionISLR(models.AbstractModel):
    _name = 'report.retention_islr.report_retention_islr1'
